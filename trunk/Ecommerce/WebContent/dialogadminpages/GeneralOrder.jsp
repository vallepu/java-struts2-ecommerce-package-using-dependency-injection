...
<div class="dialogpage">
	...
	<s:if test="orderStatus.status == 'Incomplete'">
	
		<s:form action="/ordersindaterange.action" method="POST" onsubmit="preventDoubleSubmit()">
		...
		<br />
	 	...
	 	<s:form action="/ordersindaterange.action" method="POST" onsubmit="preventDoubleSubmit()">
	  	<b>Finalizing Order Information</b><br />
     
     	<b>Shipping Cost: Dollar Amount</b><s:select label="Shipping Cost: Whole Number" 
		...
		name="shippingwholeNumber" 
		 />
		 <br />
		<b>Shipping Cost: Change</b><s:select label="Shipping Cost: Change"
	...
	<s:if test="orderStatus.status == 'Complete'">
	
		<s:form action="/ordersindaterange.action" method="POST">
		      <s:hidden name="orderpaymentId" />
		      <s:hidden name="orderId" />
		      <s:hidden name="orderpaymentId" />
		      <s:hidden name="transactionId" />
	...
	<s:if test="orderStatus.status == 'Refund'">
