...
<script type='text/javascript' src='./includes/verticalnavigation.js'></script>
	...
	<script type="text/javascript">
		...
		{
			$("#order_details").load("<%= request.getContextPath() %>/completeorder.action?orderpaymentId=" + orderpaymentid);
...
<body>
	...
	<s:url id="remoteurl" namespace="/" action="jsoncompleteordersaction">
