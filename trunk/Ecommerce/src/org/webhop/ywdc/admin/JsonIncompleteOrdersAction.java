...
public class JsonIncompleteOrdersAction extends ActionSupport 
{
	...
	public String execute()
	{
		...
		records = service.countTotalIncompleteOrders();
		...
		orderstatusList = service.getIncompletOrders(firstResult, rows);//.getIncompleteOrders();
