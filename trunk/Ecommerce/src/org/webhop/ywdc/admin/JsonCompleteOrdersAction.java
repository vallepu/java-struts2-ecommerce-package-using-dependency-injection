...
public class JsonCompleteOrdersAction extends ActionSupport 
{
	...
	public String execute()
	{
		...
		records = service.countTotalCompleteOrders();
		...
		orderstatusList = service.getCompletedOrders(firstResult, rows);
